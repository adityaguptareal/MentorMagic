...
function MenteeReviewCard(props) {
    return (
        <div className='bg-white border border-gray-400 rounded-md flex flex-col gap-4 p-4 w-fit'>
            ...
            <div id='reviewContent' className='font-montserrat'>
                ...
                <div id="review" className='text-[16px]'>{props.review}</div>
            </div>
            <div id='userProfile' className='flex gap-2 items-center'>
                ...
                <div id='userDetails' className='font-montserrat'>
                    ...
                    <p className='text-[17px] font-medium text-gray-600'>{props.date}</p>
                </div>
            </div>
