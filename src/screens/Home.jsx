        ...
        <>
            ...
            <div id='Hero' className='bg-lightPink  rounded-bl-[8.5rem] font-roboto text-[20px] tracking-wide '>
                ...
                <section id='Categories' className='my-20'>
                    ...
                    <p id="para" className='text-md font-montserrat text-center my-4'>Find the perfect mentor to guide your career journey.</p>

                    <div id="categoriesContainer" className='grid grid-rows-2 grid-cols-3 mx-auto w-full gap-x-7 gap-y-10 px-40 py-20'>
